...
export default function Right({userData, pageIndex, setPageIndex, questsData, setQuestsData, questIndex, setQuestIndex, tagsData, setTagsData, sortBy, setSortBy}) {
    ...
    return (
        <div id="right">
            ...
            { pageIndex === 1 && <Tags userData = {userData} setPageIndex = {setPageIndex} questsData = {questsData} setQuestHeader = {setQuestHeader} tagsData = {tagsData} setTagId = {setTagId}/> }
                        
            { pageIndex === 2 && <PostQuestion userData = {userData} setPageIndex = {setPageIndex} questsData = {questsData} setQuestsData = {setQuestsData} tagsData = {tagsData}/> }
            
            { pageIndex === 3 && <Answers userData = {userData} setPageIndex = {setPageIndex} questionId={questionId} tagsData ={tagsData} fromProfile = {fromProfile} setFromProfile = {setFromProfile} setAnsId = {setAnsId}/> }
            ...
            { pageIndex === 10 && <TagEdit2 setPageIndex = {setPageIndex} tagId = {tagId}/>}
